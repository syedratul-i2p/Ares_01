...
export default function Dashboard() {
  ...
  const executeLocalKeywordFallback = useCallback(async (text: string, timestamp: string, appendLog: (msg: string) => void) => {
    ...
    const hasWrist = check(['রিস্ট', 'wrist', 'কবজি', 'kobji', 'risk', 'rist', 'rest', 'রিষ্ট', 'রিস্', 'কব্জি', 'রিস্টটা', 'কব্জিটা', 'reach', 'rich']);
  ...
  const handleAiDirectiveSubmit = useCallback(async (overrideText?: string | any, source: "ai" | "voice" = "ai") => {
    ...
    if (source === "voice" && voiceLanguageRef.current === "bn-BD") {
      const realBengaliWords = [
        ...
        'রিষ্ট', 'কব্জি', 'কাধ', 'কনু', 'এলব', 'গ্রিপ', 'ক্ল', 'ঘোরাও', 'সোল্ডার', 'বেইস', 'বেজ', 'বেশ', 'bondo', 'বেইজ', 'বেস্ট', 'ব্যাস', 'দেশ', 'ফেস', 'গেস', 'ব্রেস', 'পেস', 'ভেজ', 'বেছ', 'গোড়া', 'হাত', 'আঙুল', 'আঙ্গুল', 'চিমটি', 'কামড়', 'মুঠো', 'reach', 'rich',
        // Direction words
    ...
    const isNavCommand = [
      ...
      'wrist', 'রিস্ট', 'কবজি', 'kobji', 'risk', 'rist', 'rest', 'রিষ্ট', 'কব্জি', 'reach', 'rich',
